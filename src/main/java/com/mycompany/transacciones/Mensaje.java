...
public class Mensaje {
    ...
    public String añoAnterior() {
        return "Existen fechas con años anteriores al actual ";
    }
    
    public String fechaMayorActual() {
        return "Existen fechas posteriores a la actual";
    }
}
